...
import powerImage from "./assets/images/powered.png";
...
const App = () => {
  ...
  const handleCalculateButton = (event: React.FormEvent<EventTarget>) => {
    ...
    <div className={styles.main}>
      <header>
        <div className={styles.headerContainer}>
          <img src={powerImage} alt="" width={160} />
        </div>
      </header>
      ...
      <div className={styles.container}>
        <div className={styles.leftSide}>
          ...
          <p>
            IMC é a sigla para o índice de Massa Corpórea, parâmetro adotado
